fun main() {
    ...
    while (continuar) {
        // Exibir o menu
        println("\nMenu:")
        println("1. Cadastrar um novo livro")
        println("2. Consultar livros cadastrados")
        println("3. Sair")
        ...
        when (opcao) {
            1 -> adicionarLivro(livros) // Chama a função para cadastrar um novo livro
            2 -> consultaLivros(livros) // Chama a função para consultar livros cadastrados
            3 -> {
                println("Saindo...")
...
fun consultaLivros(livros: List<Livro>){
    println("\nConsultar livros:")
